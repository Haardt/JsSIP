 ...
 *
 *  method receiveSdpOffer(options: any): Promise<RTCSessionDescriptionInit>
 *  method receiveSdpAnswer(options: any): Promise<RTCSessionDescriptionInit>
...
exports.isMediaConnection = (mediaConnection) =>
{
    ...
    try
    {
        [ 'receiveSdpOffer', 'receiveSdpAnswer', 'setLocalSdp', 'setRemoteSdp','addTrack', 'removeTracks', 'sendInbandDTMF', 'close' ].forEach((method) =>
        {
