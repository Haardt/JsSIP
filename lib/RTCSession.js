...
module.exports = class RTCSession extends EventEmitter
{
  ...
  connect(target, options = {}, initCallback)
  {
    ...
    //TODO: AH Emit the MediaConnection?
      ...
      .then(() =>
      {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          ...
          .catch((error) =>
          {
            ...
            debugerror('emit "peerconnection:setremotesdpfailed" [error:%o]', error);

            this.emit('peerconnection:setremotesdpfailed', error);
      ...
      case /^2[0-9]{2}$/.test(response.status_code):
      {
        ...
        this._connectionPromiseQueue = this._connectionPromiseQueue
          .then(() =>
          {
            ...
            return this._connection.receiveSdpOffer(this._rtcOfferConstraints)
              .catch((error) =>
              {
