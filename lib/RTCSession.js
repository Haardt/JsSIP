  ...
  _sendInitialRequest(mediaConstraints, rtcOfferConstraints, mediaStream)
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        if (this._connection.type === 'BrowserMediaConnection' && mediaStream)
        {
          return mediaStream;
        }
        // Request for user media access.
        else if (this._connection.type === 'BrowserMediaConnection' && mediaConstraints.audio || mediaConstraints.video)
        {
          return this._connection.prepareStreams(mediaConstraints)
            .catch((error) =>
            {
              if (this._status === C.STATUS_TERMINATED)
              {
      ...
      .then((stream) =>
      {
        ...
        if (this._connection.type === 'BrowserMediaConnection') {
          ...
          return this._connection.getLocalSdp()
        }
      })
      .then((desc) =>
      {
