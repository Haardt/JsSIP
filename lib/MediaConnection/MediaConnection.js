...
module.exports = class MediaConnection extends EventEmitter
{
  constructor(pcConfig, rtcPeerConnection = new RTCPeerConnection(pcConfig))
  {
    super();

    this.rtcPeerConnection = rtcPeerConnection;
    // TODO: Remove it (if tested)
  ...
  sendDTMF(tones, duration, interToneGap)
  {
    ...
    const dtmfSender = getDTMFSender()
